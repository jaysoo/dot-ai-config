...
Remove the current working directory from the **Active Claude Sessions** section in `dot_ai/TODO.md` (or `.ai/TODO.md`, whichever exists).

## Steps

1. Read `dot_ai/TODO.md` (fallback to `.ai/TODO.md`)
2. Find the "Active Claude Sessions" section
