...
## 1. [#32126](https://github.com/nrwl/nx/issues/32126) — Publishing fails with bun (hardcoded `npm view`)
...
## 2. [#34492](https://github.com/nrwl/nx/issues/34492) — esbuild executor runs pointless type-check in TS Solution Setup
...
## 3. [#34391](https://github.com/nrwl/nx/issues/34391) / [#34382](https://github.com/nrwl/nx/issues/34382) / [#33890](https://github.com/nrwl/nx/issues/33890) — `{version}` not interpolated in git tags
...
## 4. [#34399](https://github.com/nrwl/nx/issues/34399) — @nx/plugin generates unnecessary vite.config.ts
...
## 5. [#34279](https://github.com/nrwl/nx/issues/34279) — Webpack `process.env` no longer parsed after v22.2.2
...
## 6. [#34172](https://github.com/nrwl/nx/issues/34172) — VersionDataEntry interface has wrong type for dockerVersion

- **Priority: LOW | AI Suitability: HIGH**
- **Fix:** Trivial type-only fix. PR #34171 already shows the exact change needed.

## 7. [#34542](https://github.com/nrwl/nx/issues/34542) — Independent release: workspace-level file changes trigger bumps
...
## 8. [#34300](https://github.com/nrwl/nx/issues/34300) — Angular standalone + Vitest/Analog setup broken for new libraries
...
## 9. [#32832](https://github.com/nrwl/nx/issues/32832) — Docker setup missing transitive workspace dependencies
...
## 10. [#32481](https://github.com/nrwl/nx/issues/32481) — Graph: project names with `/` break focus

- **Priority: MEDIUM | AI Suitability: HIGH**
- **Core contributor:** nartc pointed to PR #32490 as the fix. URL encoding issue in graph routing.

## 11. [#31495](https://github.com/nrwl/nx/issues/31495) — `run-commands` does not honor `readyWhen` for single command
