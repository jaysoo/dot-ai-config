...
|-------|------|------------|
| 2026-08 | [2026-08.md](2026-08.md) | **Node.js security release: 11 CVEs (3 HIGH) July 29**, CVE-2026-58043 Permission Model path bypass hits Nx sandboxing, **Bun v1.4 Rust canary** (AI rewrite, 82-day stable gap), **Nx 23.1.0** (Angular v22), TC39 Await Dictionary Stage 2.7->3, Deno 2.9.4 (framework HMR), engines field confirmed intentional policy |
