...
|-------|------|------------|
| 2026-06 | [2026-06.md](2026-06.md) | **Node 20 46d post-EOL + `engines` null (8th flag)**, Node 26.3.0 (`--permission` stable, `permission.drop()`, npm 11.16.0), TC39 `using` confirmed Stage 4, Decorators regression holds at Stage 2.7, Deno 2.8.2+2.8.3 (PQC crypto + native http2 OTel), Bun silent (33d no release), Node ~June-17 security release incoming |
