...
|-------|------|------------|
| 2026-07 | [2026-07.md](2026-07.md) | **Node.js security releases: June 18 (12 CVEs, 2 HIGH) + July 27 (HIGH, CVEs pending)**, **Bun rewritten in Rust** (Anthropic, v1.4.0 canary), **Deno 2.9.4** (framework HMR, Deno 3.0 desktop announced), Node 26.5.0 (Import Text flag), Nx 23.0.x (`engines` null, 9th flag), Node 20 88 days post-EOL |
