...
|-------|------|------------|
| 2026-06 | [2026-06.md](2026-06.md) | **June 18 security releases: 2 HIGH CVEs (TLS auth bypass + WebCrypto crash)**, Node 26.3.0 (macOS Intel Tier 2, Buffer.poolSize x4), Deno 2.8.2+2.8.3 (crypto, compile watch), Bun 40-day gap, `engines` null (8th flag), TC39 Decorators still stuck at 2.7 |
