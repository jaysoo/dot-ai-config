...
| 2026-04 | `2026-04.md`                   | Turborepo 2.9.5 (96% faster TTFT, `turbo query` stable, OTel, incremental caching, cache eviction, `boundaries` circular dep detection, 32x remote cache upload, threat HIGH), Moon 2.1.4 (v2.0 WASM plugins, migration extensions), Bazel 9.0.2rc2, Gradle 9.5.0-RC2 (task provenance, Develocity CLI integration), Pants 2.32.0.dev7 (`pants-ng`, uv PEX) |
