...
| 2026-07 | `2026-07.md`                   | **CRITICAL: Cloudflare acquires VoidZero (June 4) + Vite+ Beta (July 2)** -- Rust task runner `vp run` with auto input fingerprinting, 1,300+ repos, $1M ecosystem fund. Threat escalated to HIGH. **Turborepo v2.10.5 (July 13): experimental Rust/Cargo support** (sccache embedded, Remote Cache as Cargo backend). **Moon v2.4 (July): Bazel RE gRPC remote cache interop** (Depot, BuildBuddy). **Bazel v9.2.0 (July 13)**. Turbo 3.0 abandoned. |
