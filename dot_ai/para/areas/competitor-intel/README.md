...
| 2026-07 | `2026-07.md`                   | Vite+ Beta active (v0.2.5, July 17), security hotfix in week 1. **Turborepo v2.10.4-5**: Cargo/Rust polyglot + OIDC cache auth -- Turbo no longer JS/TS-only. **Moon v2.4.0**: CAS promoted to stable (local/remote format unification now live). Bazel v9.2.0 new stable. Gradle 9.7 RC1 (Isolated Projects). |
