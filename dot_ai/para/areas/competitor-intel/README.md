...
| 2026-06 | `2026-06.md`                   | **Turborepo v2.10.0 (June 24)**: 3.0 narrative abandoned; local cache eviction (`cacheMaxAge`/`cacheMaxSize`), Ghostty TUI, pnpm v11 support. **Vite+ v0.2.0 (June 17)**: first minor -- Bingo generators, local monorepo templates, Corepack default. **DUAL SECURITY EVENT June 10**: Turbo v2.9.18 + Moon v2.3.3 cache vulns. Moon v2.3.0 CAS cache + MCP template tools remain strategic headline. Gradle 9.6.1 (June 26) patch. |
