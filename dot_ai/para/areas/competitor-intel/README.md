...
| 2026-06 | `2026-06.md`                   | **Moon v2.3.3 patches remote-cache path-traversal security bug (June 10).** Turbo v2.9.17 ships JIT input hashing (pre-release); v2.9.18 patches artifact integrity. Gradle 9.6.0 RC2 (June 11). Earlier: Moon v2.3.0 (CAS cache, native hashing, MCP template tools) upgraded Moon to HIGH threat. Turbo 2.9.15-16 stables; no 2.10/3.0 (12 weeks stale). |
