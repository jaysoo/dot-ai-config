...
| 2026-06 | `2026-06.md`                   | **Turborepo 3.0 "Agent Era" framing confirmed** -- `turbo docs` (vector-store indexing of monorepo for LLM agents) as flagship 3.0 feature; 10 weeks no stable RC. Turbo shipped v2.9.15 (Rust hardening sprint stable, `experimentalCI` stable) + v2.9.16 (PTY/Bun fixes) + canaries. Moon v2.2.6 maintenance (Go v1.24 ignore); no new AI skills at 7 weeks. Bazel 9.1.1rc1 (downloader compat revert, remote exec fixes). Pants v2.32.0 final (Python 3.14, Depot CI). Gradle unchanged since May 12. |
