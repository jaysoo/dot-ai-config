...
| 2026-06 | `2026-06.md`                   | **Moon v2.3.0 (June 1) is the headline** -- CAS local cache experiment, native file hashing 10-50% perf gain, MCP template-discovery tools (`get_template`/`get_templates`), task tags, 50-100% task memory reduction. Moon threat upgraded to HIGH. Turbo shipped v2.9.15+16 stables + 5 canaries (P-521 ECDSA, Rsbuild, auth HTTP timeouts); no 2.10/3.0 RC (11 weeks stale). Bazel 9.1.1 patch. Gradle 9.6.0 RC1 (config cache hit rate). Pants 2.32.0 final shipped. |
