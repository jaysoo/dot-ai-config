...
| 2026-06 | `2026-06.md`                   | **Turborepo v2.10.0 (June 24)**: "3.0" narrative dead (16 weeks); shipped minor with local cache eviction (cacheMaxAge/cacheMaxSize), JIT task input hashing. **DUAL SECURITY EVENT June 10**: Turbo v2.9.18 (7 hardening fixes) + Moon v2.3.3 (remote cache manifest path traversal). Moon v2.3.0 (June 1): CAS cache, MCP template tools, 10-50% native hashing. Gradle 9.6.0 FINAL (June 20). |
