...
| 2026-06 | `2026-06.md`                   | **DUAL SECURITY EVENT June 10**: Turbo v2.9.18 (7 hardening fixes incl. git argument injection, cache path containment, web UI removed) + Moon v2.3.3 (remote cache manifest path traversal). Cache security is a cross-competitor concern -- audit Nx. Moon v2.3.0 (June 1) remains the strategic headline: CAS cache, MCP template tools, 10-50% native hashing. **Gradle 9.6.0 FINAL (June 20)** -- config cache CI improvements now stable. Turbo 3.0 now 14 weeks stale. |
| 2026-07 | `2026-07.md`                   | **CRITICAL: Cloudflare acquires VoidZero (June 4) + Vite+ Beta (July 2)** -- Rust task runner `vp run` with auto input fingerprinting, 1,300+ repos, $1M ecosystem fund. Threat escalated to HIGH. **Turborepo v2.10.0** (June 26): local cache eviction, deferred input hashing, 3.0 narrative abandoned. Moon v2.3.5 patch; v2.4 pending. |
| 2026-08 | `2026-08.md`                   | **Moon v2.4.0 CAS promoted to stable** (cross-cache retrieval, OS reflinks, auto-warming). **Turborepo closes polyglot gap**: Cargo/Rust (v2.10.6) + UV Python (v2.10.8) workspace support. Vite+ v0.2.7 incremental, still no remote cache. Pants v2.33.0 stable. |
