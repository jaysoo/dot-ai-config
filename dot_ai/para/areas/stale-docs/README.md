...
|------|------|------|-------|
| 2026-06-20 | nrwl/nx | [nx-astro-docs-staleness-2026-06-20.md](./nx-astro-docs-staleness-2026-06-20.md) | Fourth scan (5 parallel agents, all 499 mdoc files); 2 critical broken guides (Rust crates recipe, self-healing-ci @v6), Windows TUI false disclaimer, 12 files with EOL Node 20/18/16, 30+ pages with pre-Nx21 version anchors, Cypress v11 guide obsolete. Linear MCP unavailable — 13 issues queued for manual creation. |
