...
|------|------|------|-------|
| 2026-06-30 | nrwl/nx | [nx-astro-docs-staleness-2026-06-30.md](./nx-astro-docs-staleness-2026-06-30.md) | Baseline correction + new findings. Nx 23.0.1 confirmed as current (was 22.x in prior scan). Removes 5 HIGH + 1 MEDIUM false positives from 2026-06-29. Adds NF-1: Angular 22 compat row requires Nx ≥23.1.0 but only 23.0.1 is out — potential undocumented gap. Net queue: 22 issues (21 carried from 2026-06-29 minus false positives + 1 new). Linear MCP still unavailable. |
