...
|------|------|------|-------|
| 2026-06-13 | nrwl/nx | [nx-astro-docs-staleness-2026-06-13.md](./nx-astro-docs-staleness-2026-06-13.md) | Cypress v11 guide misleading on Nx 23 (HIGH); Nx Cloud config stale < 17/19.6 tabs; Vite deprecation notices expiring on Nx 24; Linear MCP transport blocked |
