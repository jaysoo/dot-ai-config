...
|-------|------|------------|
| 2026-06 | [2026-06.md](./2026-06.md) | **W23 (June 8): Miasma (Red Hat npm, OIDC forge) + Phantom Gyp (binding.gyp bypass) = waves 6+7; Glasswing expands to 150 orgs/15 countries; Claude Code v2.1.168 (fallbackModel, hardened cross-session); Cursor Organizations GA.** Earlier: OpenAI breached (code-signing keys); Claude Opus 4.8 + dynamic workflows; Amazon Q sunset + Kiro; Google I/O 2026; MCP RC stateless; 97.14% autonomous LLM jailbreak; Copilot token billing live |
