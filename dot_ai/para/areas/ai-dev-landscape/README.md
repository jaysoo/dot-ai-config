...
|-------|------|------------|
| 2026-07 | [2026-07.md](./2026-07.md) | **Claude Opus 5 (July 24): 96% SWE-bench Verified, beats Fable 5 on Frontier-Bench at Opus 4.8 pricing -- default on Claude Max. MCP 2026-07-28 final spec ships July 28 (tomorrow): stateless core, initialize handshake removed (breaking); GitHub MCP Server already updated July 23.** GitHub Copilot Autonomous Agent Mode GA for Enterprise. Cursor Router (intelligent model routing) + Jira integration. Wave 7 "miasma-train-p1" (July 14): AsyncAPI npm attack; import-time execution bypasses npm v12. npm v12 ships July 8 (postinstall blocked by default). GuardFall: 10/11 open-source AI agents structural shell injection. Claude Code v2.1.220 (July 25): 5 releases post-July-20; concurrent subagent cap 20; nested depth 3. Glasswing still pending; Black Hat August 5-6. |
