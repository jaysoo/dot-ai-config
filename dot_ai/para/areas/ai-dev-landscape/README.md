...
|-------|------|------------|
| 2026-07 | [2026-07.md](./2026-07.md) | **Miasma / Wave 6 supply chain worm (June 1-17): @redhat-cloud-services, SLSA attestation forgery x2, GCP/Azure cloud identity collectors -- hardware-bound publish keys now urgent.** Claude Sonnet 5 (June 30): new default in Claude Code, near-Opus-4.8 quality at half cost. Claude Code v2.1.200: default permission mode changed to Manual; background subagents by default; auto-commit/push/open-PR. MCP SDK betas live (final spec July 28). Windsurf rebranded to Devin Desktop. Glasswing July full CVE accounting pending. 88% of orgs hit by AI agent security incidents; 29% prepared. |
