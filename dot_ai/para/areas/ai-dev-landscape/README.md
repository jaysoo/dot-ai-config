...
|-------|------|------------|
| 2026-08 | [2026-08.md](./2026-08.md) | **Claude Opus 5 (July 24): near-Fable-5 at $5/$25 per Mtok, effort-toggle. Claude Fable 5 arc: launched June 9, recalled June 12 (export controls/jailbreak), redeployed July 1 with new classifier. MCP 2026-07-28 final shipped July 28 (stateless core, 10k+ servers). Phantom Gyp / Wave 8 (June 3-4): binding.gyp bypasses npm v12 day 1 -- gap from July scan. Glasswing Linux LPE CVE-2026-8834; Black Hat Aug 5-6 imminent.** |
