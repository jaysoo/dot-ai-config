...
|-------|------|------------|
| 2026-06 | [2026-06.md](./2026-06.md) | **CRITICAL: Fable 5 + Mythos 5 released June 9, suspended globally June 12 by US government export directive (first government-mandated AI model blackout).** Miasma/Shai-Hulud Wave 6: Red Hat npm (June 1) + Phantom Gyp binding.gyp bypass (June 3-4) -- SLSA attestation forgery confirmed again. Claude Code v2.1.159->v2.1.185 (26 patches: Artifacts, enforceAvailableModels, destructive-cmd blocks). Copilot SDK GA (June 2) + Cursor 3.8 Automations + computer use. Windsurf rebranded to Devin Desktop. Kiro CLI V3 early access. Earlier: OpenAI breach (May 15), Opus 4.8, Google I/O, MCP RC stateless core, Glasswing 10k+ vulns, 97.14% autonomous jailbreak |
