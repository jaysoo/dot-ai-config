...
|-------|------|------------|
| 2026-06 | [2026-06.md](./2026-06.md) | **W24 (Jun 15): Fable 5 + Mythos 5 launched June 9, suspended June 12 by US gov export directive (first frontier model suspension via export control). Miasma CI/CD pipeline hijack (OIDC, SLSA provenance valid on malicious packages -- SLSA alone insufficient). IronWorm Rust/eBPF targets Anthropic API keys. Copilot SDK GA. Claude Code sub-agents 5 levels deep.** W22 (Jun 1): OpenAI breached via TanStack; Opus 4.8 + dynamic workflows; Amazon Q sunset + Kiro; Google I/O Antigravity 2.0/Gemini 3.5 Flash/Managed Agents; MCP RC stateless core; Glasswing 10k+ vulns; LLM autonomous jailbreak 97.14% |
