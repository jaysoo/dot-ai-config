...
| Month | Key Events |
|-------|-----------|
| [2026-06](./2026-06.md) | **Angular 22 GA (22.0.4)** -- `@nx/angular` peer-dep conflict (GitHub #35910) still blocks user migrations; **React Router v8.0.1**; **Vite 8.1.0** (Bundled Dev Mode 15x faster, Lightning CSS); **Rspack 2.1.1** (`import.meta.glob`, `pureFunctions` default-on, TS7); **webpack 5.108** (Bun/Deno/Universal targets, `output.html`); Vue 3.6-beta.15 (Vapor Mode feature-complete, RC imminent); Next.js 16.3 canary.61 |
