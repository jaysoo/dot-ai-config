...
| Month | Key Events |
|-------|-----------|
| [2026-06](./2026-06.md) | **Cloudflare acquires VoidZero** (June 4) -- Vite, Rolldown, Oxc, Vitest now Cloudflare-owned; MIT/OSS pledges made, $1M ecosystem fund. Angular 22.0.0 GA (June 3) + 22.0.1; OnPush default, Signal Forms stable, Resource API stable, Node 22+/TS 6+. Rolldown 1.1.1 (first minor post-1.0). Vite 8.1.0-beta.0 (full-bundle mode). React Router 7.17.0 rapid cadence. Next.js 16.3 GA slips. |
