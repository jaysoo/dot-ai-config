...
| Month | Key Events |
|-------|-----------|
| [2026-07](./2026-07.md) | **#35910 closed** -- Angular 22 peer-dep unblocked; React Router 8.2.0 (Web Streams default for non-Node runtimes); Vite 8.1.x (`server.hmr` -> `server.ws`); Rspack 2.1.x (React Compiler, pure-fn analysis, `maxGenerations` rename); webpack 5.108 (`globalThis` default, Bun/Deno targets); Rolldown 1.1.5 (21 bug fixes); Next.js canary.84 |
