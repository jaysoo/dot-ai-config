...
| Month | Key Events |
|-------|-----------|
| [2026-07](./2026-07.md) | **Nx 23.1 ships Angular 22** (Angular 19 + ESLint v8 dropped); **Nuxt 3 EOL July 31**; **Vue 3.6 RC** (Vapor Mode feature-complete); Nuxt 4.5.0 (Vite 8 default, SSR streaming); Rolldown 1.2.0 (`[format]` es/esm rename); React Router 8.2.0; Next.js canary.90 (TS7 experimental); Angular 22.0.7 (ReDoS fix) |
