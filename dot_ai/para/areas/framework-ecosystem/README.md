...
| Month | Key Events |
|-------|-----------|
| [2026-07](./2026-07.md) | **Nuxt 4.5 (Vite 8 required, Nuxt 3 EOL July 31)**; **Vue 3.6.0-rc.2** (Vapor Mode feature-complete, alien-signals reactivity); **webpack 5.109** (TS auto-mode, import.meta.glob/env, importMetaContext deprecated); **RR 8.3.0** (RSC entries, TS7 compat); **Rolldown 1.2** (per-client HMR); Angular 22.1.0-rc.0; Next.js canary.97 |
