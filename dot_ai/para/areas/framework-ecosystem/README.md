...
| Month | Key Events |
|-------|-----------|
| [2026-08](./2026-08.md) | **Nuxt 4.5.1 CRITICAL SECURITY** (RCE/CVEs -- pin immediately); Angular 22.1.0 GA (JSONP deprecated); React Router 8.3.0 (RSC virtual modules, web streams); Next.js 16.2.11 security + `experimental.useCache` deprecated; webpack 5.109 (experiments auto); Rolldown 1.2.0 (`format: 'es'`); Vue 3.6 RC stage |
| [2026-07](./2026-07.md) | **#35910 closed** -- Angular 22 peer-dep unblocked; Vite 8.1.x (`server.hmr` -> `server.ws`); Rspack 2.1.x (React Compiler, pure-fn analysis, `maxGenerations` rename); webpack 5.108 (`globalThis` default, Bun/Deno targets); Rolldown 1.1.4 reverts `lazyBarrel` default; Remix v3 beta.5 (5 betas in 2 months); Next.js canary.78 |
