...
| Month | Key Events |
|-------|-----------|
| [2026-06](./2026-06.md) | Angular 22.0.0 GA (June 3): Vitest default test runner, OnPush default, Signal Forms + @angular/aria + MCP server stable; React Router 7.17 + v8 imminent (React 19/Node 22.12/Vite 7+ required); Rolldown 1.1.0 (lazyBarrel default-on); Rspack 2.0.6 (RSC boundary validation); Nuxt 4.4.7 security hotfix; Next.js 16.3 GA slipped |
