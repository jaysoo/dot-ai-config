...
|-------|------|----------|----------|
| 2026-04 | [2026-04.md](2026-04.md) | HIGH | 15H/47M/23L -- 12 undocumented packages, 40 undocumented generators, 3 undocumented AI CLI commands, v22/v23 deprecation wave |
...
5. **12 entire packages** with generators/executors have zero documentation
