...
### 2026-06-10 - NXC-4453: Document nx migrate agentic flow + --include (draft PR)
- **Branch**: `feature/nxc-4453-update-docs-to-account-for-agentic-flow` | **Worktree**: `/Users/jack/projects/nx-worktrees/NXC-4453` | **PR**: https://github.com/nrwl/nx/pull/35917 (draft) | **Commit**: `0f4b8eebc2` (single squashed commit, amended ~10x across 2026-06-05..06-10) | **Polygraph**: `docs-agentic--migrate-de6a34c5` | Linear NXC-4453 (project "nx migrate Revamp")
