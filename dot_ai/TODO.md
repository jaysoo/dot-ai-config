...
1. **NXC-3711: Remove Tailwind Support** (2026-03-27, in progress)
...
2. **CNW Template Updates 22.6.2 + Vite 8 + Angular 21.2.5** (2026-03-27, completed)
...
3. **NXC-4152: Fix Vite 8 cypress-component-configuration test failures** (2026-03-27)
...
4. **DOC-457: Webinar banner light mode support** (2026-03-26)
...
5. **Docs: Getting started tutorial links** (2026-03-26)
...
6. **NXC-3345: Rollup + SWC rootDir fix for workspace libs** (2026-03-25, in progress)
...
7. **Vite 8 Support (community PR #34850)** (2026-03-25, in progress)
...
8. **NXC-4141: Reduce Push to GitHub Errors** (2026-03-25, completed)
...
9. **DOC-452: Topic-Based Tutorial Series** (2026-03-25, completed)
   - Summary: Replaced monolithic tutorials with 8 focused topic pages. PR #34998 merged. Follow-up PR #35024 for getting started links.
   - Files: `.ai/2026-03-25/SUMMARY.md`, PR: https://github.com/nrwl/nx/pull/34998

10. **CLOUD-4390: ClickUp Exit Code 2 Investigation** (2026-03-25, completed)
    ...
    - Files: `.ai/2026-03-25/SUMMARY.md`
