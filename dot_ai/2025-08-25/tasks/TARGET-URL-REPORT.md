# Target URL Validation Report for canary.nx.dev
...
- `/ci/recipes/set-up/monorepo-ci-github-actions` → `/docs/ci/recipes/set-up/monorepo-ci-github-actions` (404)
...
- `/ci/reference/custom-images` → `/docs/ci/reference/custom-images` (404)
...
- `/extending-nx/api/nx-devkit/overview` → `/docs/extending-nx/api/nx-devkit/overview` (404)
...
- `/recipes/running-tasks/change-cache-location` → `/docs/recipes/running-tasks/change-cache-location` (404)
...
- `/recipes/enforce-module-boundaries/ban-external-imports` → `/docs/recipes/enforce-module-boundaries/ban-external-imports` (404)
...
- `/reference/core-api/devkit/documents/CreateMetadata` → `/docs/reference/core-api/devkit/documents/CreateMetadata` (404)
...
- `/reference/core-api/devkit/documents/JsonSerializeOptions` → `/docs/reference/core-api/devkit/documents/JsonSerializeOptions` (404)
...
- `/reference/core-api/devkit/documents/StringInsertion` → `/docs/reference/core-api/devkit/documents/StringInsertion` (404)
...
- `/reference/core-api/devkit/documents/getPackageManagerVersion` → `/docs/reference/core-api/devkit/documents/getPackageManagerVersion` (404)
...
- `/reference/core-api/devkit/documents/runExecutor` → `/docs/reference/core-api/devkit/documents/runExecutor` (404)
...
- `/reference/core-api/nx/documents/sync-check` → `/docs/reference/core-api/nx/documents/sync-check` (404)
...
- `/reference/core-api/workspace/executors/counter` → `/docs/reference/core-api/workspace/executors/counter` (404)
...
- `/reference/core-api/s3-cache/migrations` → `/docs/reference/core-api/s3-cache/migrations` (404)
...
- `/technologies/angular/recipes/dynamic-module-federation-with-angular` → `/docs/technologies/angular/recipes/dynamic-module-federation-with-angular` (404)
...
- `/technologies/vue/nuxt/recipes` → `/docs/technologies/vue/nuxt/recipes` (404)
...
- `/technologies/build-tools/rspack/recipes` → `/docs/technologies/build-tools/rspack/recipes` (404)
...
- `/technologies/angular/api/executors/module-federation-dev-server` → `/docs/technologies/angular/api/executors/module-federation-dev-server` (404)
...
- `/technologies/angular/api/generators/scam-pipe` → `/docs/technologies/angular/api/generators/scam-pipe` (404)
...
- `/technologies/eslint/api/executors/lint` → `/docs/technologies/eslint/api/executors/lint` (404)
...
- `/technologies/node/express/api/migrations` → `/docs/technologies/node/express/api/migrations` (404)
...
- `/technologies/node/nest/api/generators/application` → `/docs/technologies/node/nest/api/generators/application` (404)
...
- `/technologies/node/api/generators/application` → `/docs/technologies/node/api/generators/application` (404)
...
- `/technologies/react/api/generators/setup-ssr` → `/docs/technologies/react/api/generators/setup-ssr` (404)
...
- `/technologies/react/remix/api/generators/route` → `/docs/technologies/react/remix/api/generators/route` (404)
...
- `/technologies/build-tools/rollup/api/generators/convert-to-inferred` → `/docs/technologies/build-tools/rollup/api/generators/convert-to-inferred` (404)
- `/technologies/build-tools/rollup/api/migrations` → `/docs/technologies/build-tools/rollup/api/migrations` (404)
- `/technologies/build-tools/rsbuild/api/executors` → `/docs/technologies/build-tools/rsbuild/api/executors` (404)
- `/technologies/build-tools/rsbuild/api/generators` → `/docs/technologies/build-tools/rsbuild/api/generators` (404)
- `/technologies/build-tools/rsbuild/api/generators/init` → `/docs/technologies/build-tools/rsbuild/api/generators/init` (404)
- `/technologies/build-tools/rsbuild/api/generators/configuration` → `/docs/technologies/build-tools/rsbuild/api/generators/configuration` (404)
- `/technologies/build-tools/rsbuild/api/migrations` → `/docs/technologies/build-tools/rsbuild/api/migrations` (404)
- `/technologies/build-tools/rspack/api/executors` → `/docs/technologies/build-tools/rspack/api/executors` (404)
- `/technologies/build-tools/rspack/api/executors/rspack` → `/docs/technologies/build-tools/rspack/api/executors/rspack` (404)
- `/technologies/build-tools/rspack/api/executors/dev-server` → `/docs/technologies/build-tools/rspack/api/executors/dev-server` (404)
- `/technologies/build-tools/rspack/api/executors/ssr-dev-server` → `/docs/technologies/build-tools/rspack/api/executors/ssr-dev-server` (404)
- `/technologies/build-tools/rspack/api/executors/module-federation-dev-server` → `/docs/technologies/build-tools/rspack/api/executors/module-federation-dev-server` (404)
- `/technologies/build-tools/rspack/api/executors/module-federation-ssr-dev-server` → `/docs/technologies/build-tools/rspack/api/executors/module-federation-ssr-dev-server` (404)
- `/technologies/build-tools/rspack/api/executors/module-federation-static-server` → `/docs/technologies/build-tools/rspack/api/executors/module-federation-static-server` (404)
- `/technologies/build-tools/rspack/api/generators` → `/docs/technologies/build-tools/rspack/api/generators` (404)
- `/technologies/build-tools/rspack/api/generators/configuration` → `/docs/technologies/build-tools/rspack/api/generators/configuration` (404)
- `/technologies/build-tools/rspack/api/generators/init` → `/docs/technologies/build-tools/rspack/api/generators/init` (404)
- `/technologies/build-tools/rspack/api/generators/preset` → `/docs/technologies/build-tools/rspack/api/generators/preset` (404)
- `/technologies/build-tools/rspack/api/generators/application` → `/docs/technologies/build-tools/rspack/api/generators/application` (404)
- `/technologies/build-tools/rspack/api/generators/convert-webpack` → `/docs/technologies/build-tools/rspack/api/generators/convert-webpack` (404)
- `/technologies/build-tools/rspack/api/generators/convert-config-to-rspack-plugin` → `/docs/technologies/build-tools/rspack/api/generators/convert-config-to-rspack-plugin` (404)
- `/technologies/build-tools/rspack/api/generators/convert-to-inferred` → `/docs/technologies/build-tools/rspack/api/generators/convert-to-inferred` (404)
- `/technologies/build-tools/rspack/api/migrations` → `/docs/technologies/build-tools/rspack/api/migrations` (404)
- `/technologies/test-tools/storybook/api/executors` → `/docs/technologies/test-tools/storybook/api/executors` (404)
- `/technologies/test-tools/storybook/api/executors/storybook` → `/docs/technologies/test-tools/storybook/api/executors/storybook` (404)
- `/technologies/test-tools/storybook/api/executors/build` → `/docs/technologies/test-tools/storybook/api/executors/build` (404)
- `/technologies/test-tools/storybook/api/generators` → `/docs/technologies/test-tools/storybook/api/generators` (404)
- `/technologies/test-tools/storybook/api/generators/init` → `/docs/technologies/test-tools/storybook/api/generators/init` (404)
- `/technologies/test-tools/storybook/api/generators/configuration` → `/docs/technologies/test-tools/storybook/api/generators/configuration` (404)
- `/technologies/test-tools/storybook/api/generators/convert-to-inferred` → `/docs/technologies/test-tools/storybook/api/generators/convert-to-inferred` (404)
- `/technologies/test-tools/storybook/api/generators/migrate-8` → `/docs/technologies/test-tools/storybook/api/generators/migrate-8` (404)
- `/technologies/test-tools/storybook/api/generators/migrate-9` → `/docs/technologies/test-tools/storybook/api/generators/migrate-9` (404)
- `/technologies/test-tools/storybook/api/migrations` → `/docs/technologies/test-tools/storybook/api/migrations` (404)
- `/technologies/build-tools/vite/api/executors` → `/docs/technologies/build-tools/vite/api/executors` (404)
- `/technologies/build-tools/vite/api/executors/dev-server` → `/docs/technologies/build-tools/vite/api/executors/dev-server` (404)
- `/technologies/build-tools/vite/api/executors/build` → `/docs/technologies/build-tools/vite/api/executors/build` (404)
- `/technologies/build-tools/vite/api/executors/test` → `/docs/technologies/build-tools/vite/api/executors/test` (404)
- `/technologies/build-tools/vite/api/executors/preview-server` → `/docs/technologies/build-tools/vite/api/executors/preview-server` (404)
- `/technologies/build-tools/vite/api/generators` → `/docs/technologies/build-tools/vite/api/generators` (404)
- `/technologies/build-tools/vite/api/generators/init` → `/docs/technologies/build-tools/vite/api/generators/init` (404)
- `/technologies/build-tools/vite/api/generators/configuration` → `/docs/technologies/build-tools/vite/api/generators/configuration` (404)
- `/technologies/build-tools/vite/api/generators/setup-paths-plugin` → `/docs/technologies/build-tools/vite/api/generators/setup-paths-plugin` (404)
- `/technologies/build-tools/vite/api/generators/convert-to-inferred` → `/docs/technologies/build-tools/vite/api/generators/convert-to-inferred` (404)
- `/technologies/build-tools/vite/api/generators/vitest` → `/docs/technologies/build-tools/vite/api/generators/vitest` (404)
- `/technologies/build-tools/vite/api/migrations` → `/docs/technologies/build-tools/vite/api/migrations` (404)
- `/technologies/vue/api/executors` → `/docs/technologies/vue/api/executors` (404)
- `/technologies/vue/api/generators` → `/docs/technologies/vue/api/generators` (404)
- `/technologies/vue/api/generators/init` → `/docs/technologies/vue/api/generators/init` (404)
- `/technologies/vue/api/generators/application` → `/docs/technologies/vue/api/generators/application` (404)
- `/technologies/vue/api/generators/library` → `/docs/technologies/vue/api/generators/library` (404)
- `/technologies/vue/api/generators/component` → `/docs/technologies/vue/api/generators/component` (404)
- `/technologies/vue/api/generators/setup-tailwind` → `/docs/technologies/vue/api/generators/setup-tailwind` (404)
- `/technologies/vue/api/generators/storybook-configuration` → `/docs/technologies/vue/api/generators/storybook-configuration` (404)
- `/technologies/vue/api/generators/stories` → `/docs/technologies/vue/api/generators/stories` (404)
- `/technologies/vue/api/migrations` → `/docs/technologies/vue/api/migrations` (404)
- `/technologies/build-tools/webpack/api/executors` → `/docs/technologies/build-tools/webpack/api/executors` (404)
- `/technologies/build-tools/webpack/api/executors/webpack` → `/docs/technologies/build-tools/webpack/api/executors/webpack` (404)
- `/technologies/build-tools/webpack/api/executors/dev-server` → `/docs/technologies/build-tools/webpack/api/executors/dev-server` (404)
- `/technologies/build-tools/webpack/api/executors/ssr-dev-server` → `/docs/technologies/build-tools/webpack/api/executors/ssr-dev-server` (404)
- `/technologies/build-tools/webpack/api/generators` → `/docs/technologies/build-tools/webpack/api/generators` (404)
- `/technologies/build-tools/webpack/api/generators/init` → `/docs/technologies/build-tools/webpack/api/generators/init` (404)
- `/technologies/build-tools/webpack/api/generators/configuration` → `/docs/technologies/build-tools/webpack/api/generators/configuration` (404)
- `/technologies/build-tools/webpack/api/generators/convert-config-to-webpack-plugin` → `/docs/technologies/build-tools/webpack/api/generators/convert-config-to-webpack-plugin` (404)
- `/technologies/build-tools/webpack/api/generators/convert-to-inferred` → `/docs/technologies/build-tools/webpack/api/generators/convert-to-inferred` (404)
- `/technologies/build-tools/webpack/api/migrations` → `/docs/technologies/build-tools/webpack/api/migrations` (404)
...
### Fix Broken Mappings (955 total)

These redirect rules point to non-existent pages. Either:
1. The target pages need to be created in the new docs
2. The redirect mappings need to be updated to point to existing pages
3. Find alternative pages that cover the same content

Sample broken mappings to investigate:

- `/ci` → `/docs/ci` (doesn't exist)
- `/extending-nx` → `/docs/extending-nx` (doesn't exist)
- `/getting-started/adding-to-existing` → `/docs/getting-started/adding-to-existing` (doesn't exist)
- `/getting-started/ai-integration` → `/docs/getting-started/ai-integration` (doesn't exist)
- `/getting-started/tutorials/typescript-packages-tutorial` → `/docs/getting-started/tutorials/typescript-packages-tutorial` (doesn't exist)
- `/getting-started/tutorials/react-monorepo-tutorial` → `/docs/getting-started/tutorials/react-monorepo-tutorial` (doesn't exist)
- `/getting-started/tutorials/angular-monorepo-tutorial` → `/docs/getting-started/tutorials/angular-monorepo-tutorial` (doesn't exist)
- `/getting-started/tutorials/gradle-tutorial` → `/docs/getting-started/tutorials/gradle-tutorial` (doesn't exist)
- `/features/maintain-ts-monorepos` → `/docs/features/maintain-ts-monorepos` (doesn't exist)
- `/recipes` → `/docs/recipes` (doesn't exist)

... and 945 more broken mappings
