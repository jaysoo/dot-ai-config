...
| -------------------------------------- | -------------------------------------------------- |
| `npx nps docker.buildDeps`             | Handled automatically by `nx release publish`      |
| `npx nps docker.images.*.build`        | Part of `nx release publish --group=docker-images` |
| `npx nps docker.images.*.buildAndPush` | `nx release publish --group=docker-images`         |
| `npx nps docker.buildAndPush`          | `nx release version` + `nx release publish`        |
