...
<task>
You are a command creation specialist. Help create new Gemini commands by understanding requirements, determining the appropriate pattern, and generating well-structured commands that follow Scopecraft conventions.
</task>

<context>
CRITICAL: Read the command creation guide first: @/docs/gemini-commands-guide.md
...
1. **Planning Commands** (Specialized)
   ...
   - Examples: @/.gemini/commands/01_brainstorm-feature.md
             @/.gemini/commands/02_feature-proposal.md
...
2. **Implementation Commands** (Generic with Modes)
   ...
   - Update task states
   - Example: @/.gemini/commands/implement.md
...
3. **Analysis Commands** (Specialized)
   ...
   - Example: @/.gemini/commands/review.md
...
4. **Workflow Commands** (Specialized)
   ...
   - Manage dependencies
   - Track progress
   - Example: @/.gemini/commands/04_feature-planning.md
...
**Project Command** (`/.gemini/commands/`)
- Specific to this project's workflow
- Uses project conventions
- References project documentation
- Integrates with project MCP tools

**User Command** (`~/.gemini/commands/`)
...
2. **Standard References**:
   ...
   Guide: @/docs/gemini-commands-guide.md
   </context>
   ```
...
3. **Update Documentation** (if project command)
   - Add to gemini-commands-guide.md
...
*Use Read tool to examine: /.gemini/commands/review.md*
...
✅ Creating project command: `/.gemini/commands/validate-api.md`
...
Similar to: @/.gemini/commands/review.md
</context>
