...
description: >
  ...
  Triggers when modifying GEMINI.md, skills, commands, settings, or dotfiles (kitty, fish, nvim, mise, git).
...
- Edit, write, or create files under `~/.gemini/` (GEMINI.md, skills/*, commands/*, settings.json, settings.local.json)
