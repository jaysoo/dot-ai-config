...
| Tutorials switch to Cloud CTA | **July 10, 2025** | | Tutorials in `nx.dev` (later `astro-docs`) changed primary onboarding from CLI to `cloud.nx.app/create-nx-workspace`. |
...
| Tutorials switch back to CLI | **Mar 20, 2026** | | Reverted `npx create-nx-workspace` as primary tutorial path due to browser friction and ~33% drop in CNW starts. |
